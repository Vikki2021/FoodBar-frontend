        ...
        .map((order) => {
          ...
          return {
            ...
            displayDate: isValidDate
              ? orderTimestamp.toLocaleDateString("en-GB")
              : new Date().toLocaleDateString("en-GB"),
            displayTime: isValidDate
              ? orderTimestamp.toLocaleTimeString("en-GB", {
                  hour: "2-digit",
                  minute: "2-digit",
                  second: "2-digit",
                })
      ...
      <div className="container mt-5 py-5">
        ...
        {loading ? (
          ...
          <div>
            {Object.keys(ordersGroupedByDate).map((date) => (
              <div key={date} className="mb-5">
                <h4
                  className="text-center text-info mb-4 p-2 rounded"
                  style={{
          ...
          <p className="text-muted text-center mt-4">
            No orders to display or all items were invalid.
          </p>
        )}
      </div>
