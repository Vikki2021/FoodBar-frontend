        ...
        <div className="container my-5">
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-lg-7 mb-4 mb-lg-0 text-lg-start text-center">
              ...
              >
                Your culinary journey begins here. Explore a wide array of
                delicious meals from your favorite local restaurants, delivered
              ...
              <div className="d-flex justify-content-lg-start justify-content-center flex-wrap">
                <Link
                  to="/menu"
                  className="btn btn-warning btn-lg fw-bold text-dark px-4 py-2 me-2 mb-2"
                >
                  Order Now!
                </Link>
                <Link
                  to="/aboutus"
                  className="btn btn-outline-warning btn-lg fw-bold text-warning px-4 py-2 mb-2"
                >
                  Learn More
                </Link>
              </div>
        ...
        <div className="row justify-content-center g-4">
          <div className="col-md-4">
            <div
              ...
              style={{ background: "#2c3034", border: "1px solid #495057" }}
            >
              <h4 className="text-warning mb-3">Fast & Reliable</h4>
              <p className="text-light">
                Get your food delivered swiftly, right when you crave it.
              </p>
            </div>
          </div>
          <div className="col-md-4">
            ...
            >
              ...
              <p className="text-light">
                From local delicacies to international flavors, find your
                perfect meal.
              </p>
            </div>
          </div>
          <div className="col-md-4">
            ...
            >
              ...
              <p className="text-light">
                A few clicks are all it takes to satisfy your hunger.
              </p>
            </div>
          </div>
        </div>
